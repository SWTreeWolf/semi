	...
	<div id="contents">
 		<div id="contents_top">
   			<div id="roll_banner_wrap">
     			...
     			<p class="ctl_btn">
       				<a href="#" class="playBtn"><img src="home/images/pop_btn_play_on.gif" alt="재생 버튼" /></a> 
       				<a href="#" class="stopBtn"><img src="home/images/pop_btn_stop_off.gif" alt="정지 버튼" /></a>
     			</p>
   			</div>   			
   			<dl id="tabmenu">
     			<dt class="tab_btn1">
				...
				<dd>
					<ul>
						<c:forEach items="${aList}" var="dto">													
					    		<li><a href="#">${dto.employee_id}</a><span>${dto.first_name}</span></li>					    	
					    </c:forEach>
					</ul>
					<p><a href="#"><img src="home/images/tab_more_btn.gif" alt="더보기" /></a></p>
				</dd>
     			<dt class="tab_btn2">
     			...
     			<dd>
					<ul>
						<%-- <c:forEach items="${requestScope.aList}" var="dto">
							<c:if test='${dto.gubun=="dep" }'>						
					    		<li><a href="#">${dto.title}</a> <span>no.${dto.num}</span> </li>
					    	</c:if>
					    </c:forEach> --%>
					</ul>
	       			<p><a href="#"><img src="home/images/tab_more_btn.gif" alt="더보기" /></a></p>
   			...
   			<ul id="consult_wrap">
     				<li><img src="home/images/banner_consult.gif" alt="출판 상담 문의 02-3235-1722" /></li>
     				<li>
 		...
 		<div id="bestbook_zone">
   			<h3><img src="home/images/bestbook_title.gif" alt="이지스퍼블리싱 베스트 책" /></h3>
   			<div id="best_bg">
	      		<ul>
	        		<li>
	        			<a href="#"><img src="home/images/bestbook_list_1.png" alt="" /><span><strong>책 제목</strong>책 저자</span></a>
	        		</li>
				    <li>
				    	<a href="#"><img src="home/images/bestbook_list_2.png" alt="" /><span><strong>책 제목</strong>책 저자</span></a>
				    </li>
				    <li>
				    	<a href="#"><img src="home/images/bestbook_list_3.png" alt="" /><span><strong>책 제목</strong>책 저자</span></a>
				    </li>
				    <li>
				    	<a href="#"><img src="home/images/bestbook_list_4.png" alt="" /><span><strong>책 제목</strong>책 저자</span></a>
				    </li>
				    <li>
				    	<a href="#"><img src="home/images/bestbook_list_5.png" alt="" /><span><strong>책 제목</strong>책 저자</span></a>
				    </li>
				    <li>
				       	<a href="#"><img src="home/images/bestbook_list_6.png" alt="" /><span><strong>책 제목</strong>책 저자</span></a>
				    </li>
				    <li>
				       	<a href="#"><img src="home/images/bestbook_list_7.png" alt="" /><span><strong>책 제목</strong>책 저자</span></a>
				    </li>
				    <li>
				       	<a href="#"><img src="home/images/bestbook_list_8.png" alt="" /><span><strong>책 제목</strong>책 저자</span></a>
				    </li>
	        		<li>
	        			<a href="#"><img src="home/images/bestbook_list_9.png" alt="" /><span><strong>책 제목</strong>책 저자</span></a>
	      			</li>
				    <li>
				       	<a href="#"><img src="home/images/bestbook_list_10.png" alt="" /><span><strong>책 제목</strong>책 저자</span></a>
				    </li>
				</ul>
      			<p class="prev_btn">
         			<a href="#"><img src="home/images/bestbook_btn_left.png" alt="이전으로 이동" /></a>
      			</p>
     			 <p class="next_btn">
         			<a href="#"><img src="home/images/bestbook_btn_right.png" alt="다음으로 이동" /></a>
      			</p>
   			</div>
 		...
 		<div id="contents_bottom">
   			...
   			<div id="marketing_wrap">
     			...
     			<dl class="first">
		       		<dt><a href="#">Do it! HTML5+CSS3 웹 표준의 정석 동영상 강좌</a></dt>
		       		<dd class="img_wrap"><a href="#"><img src="home/images/maket_img_1.gif" alt="" /></a></dd>
		       		<dd><a href="#">기초부터 반응형 웹까지! HTMl5 권위자에게 정석으로...</a></dd>
     			</dl>
     			<dl>
     				<dt><a href="#">Do it! 안드로이드 진도표와 동영상 강좌</a></dt>
			       	<dd class="img_wrap"><a href="#"><img src="home/images/maket_img_2.gif" alt="" /></a></dd>
			       	<dd><a href="#">처음부터 끝까지 보기 힘든 초보자를 위해 섹션별 난이도를 표시해 놓았습니다.</a></dd>
				</dl>
   			</div>
   			<div id="online_wrap">
     			<h3><img src="home/images/online_title.gif" alt="온라인 서점" /></h3>
		     	<ul>
		       		<li><a href="#"><img src="home/images/online_banner_1.gif" alt="배너1" /></a></li>
		       		<li class="fl_r"><a href="#"><img src="home/images/online_banner_2.gif" alt="배너2" /></a></li>
		       		<li><a href="#"><img src="home/images/online_banner_3.gif" alt="배너3" /></a></li>
		       		<li class="fl_r"><a href="#"><img src="home/images/online_banner_4.gif" alt="배너4" /></a></li>
		       		<li><a href="#"><img src="home/images/online_banner_5.gif" alt="배너5" /></a></li>
		       		<li class="fl_r"><a href="#"><img src="home/images/online_banner_6.gif" alt="배너6" /></a></li>
		     	</ul>
			</div>
 		...
 		<div id="quick_menu">
   			...
   			<ul>
		    	<li><a href="#"><img src="home/images/quick_list_1.png" alt="저자지원" /></a></li>
		     	<li><a href="#"><img src="home/images/quick_list_2.png" alt="교재/강의 요청" /></a></li>
		     	<li><a href="#"><img src="home/images/quick_list_3.png" alt="신간도서" /></a></li>
		     	<li><a href="#"><img src="home/images/quick_top_btn.png"  alt="상단으로 이동" /></a></li>
		   </ul>
 		</div> <!-- close of quick_menu -->
 		<p id="pop_wrap">
...
<div id="footer_wrap">
	<div id="inner_footer">
 		<h3 class="footer_logo"><a href="#"><img src="home/images/footer_logo.gif" alt="이지스퍼블리싱" /></a></h3>
 		<dl id="bottom_menu">
