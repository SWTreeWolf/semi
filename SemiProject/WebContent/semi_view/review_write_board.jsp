...
<body>
	...
	<!-- 바디 시작-->
	<form name="write_board" method="post" enctype="multipart/form-data"
		action="write.do" style="margin: 0px;">
...
img {
	...
	var char_max = parseInt(0);//최대
														...
														<table width="100%" border="0" cellspacing="0"
															...
															<tbody>
																...
																<tr>
																	...
																	<td><input class="ed" type="password"
																		maxlength="20" size="15" name="wr_password"
																...
																<tr>
																	...
																	<td><input class="ed" maxlength=100 " size="50"
																		name="wr_email" email="" itemname="이메일" value=""></td>
																</tr>
																<tr>
																	<td colspan="2" height="1" bgcolor="#e7e7e7"></td>
																</tr>
																...
																<tr>
																	...
																	<td><input class="ed" size="50" name="wr_subject"
																...
																<tr>
																	...
																	<td colspan="2"><textarea id="summernote"></textarea>
																		<textarea id="summercontent" name="summercontent"
																...
																<tr>
																	...
																	<td><input type="text" class="ed" size="50"
																		name="wr_link1" itemname="링크#1" value=""></td>
																</tr>
																<tr>
																	<td colspan="2" height="1" bgcolor="#e7e7e7"></td>
																</tr>
																	...
																	<td class="write_head">
																		<table cellpadding="0" cellspacing="0">
																			<tbody>
																				<tr>
																					<td class="write_head"
																						style="padding-top: 30px; line-height: 20px;">&nbsp;파일첨부<br>
																						<span onclick="add_file();"
																						style="cursor: pointer;"><img
																							src="../semi_view/images/btn_file_add.gif"></span>
																						<span onclick="del_file();"
																						style="cursor: pointer;"><img
																							src="../semi_view/images/btn_file_minus.gif"></span>
																					</td>
																				</tr>
																			</tbody>
																		</table>
																		...
																		<table id="variableFiles" cellpadding="0"
																			...
																			function add_file(
																				...
																				if (document.getElementById)
																					objTbl = document
																							.getElementById("variableFiles");
																				else
																					objTbl = document.all["variableFiles"];

																				objRow = objTbl
																						.insertRow(objTbl.rows.length);
																				objCell = objRow
																						.insertCell(0);
																			...
																			function del_file() {
																				...
																				if (objTbl.rows.length - 1 > file_length) {
																					objTbl
																							.deleteRow(objTbl.rows.length - 1);
																					flen--;
																				}
																			}
																		</script>
															...
															<tbody>
																<tr>
																	<td width="100%" align="center" valign="top"
																		...
																		id="btn_submit"
																		src="../semi_view/images/btn_write.gif" border="0"
																		accesskey="s">&nbsp;<a href="review_board.do"><img
																			id="btn_list" src="../semi_view/images/btn_list.gif"
																			border="0"></a></td>
																</tr>
															</tbody>
														</table>
										...
										<script src="../semi_view/dist/summernote.js"></script> <script
											src="../semi_view/dist/lang/summernote-ko-KR.js"></script> <script
