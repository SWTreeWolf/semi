	...
	<section class="content" id="container">
		...
		<div class="diameter">
			<div class="diameter_bxslider">
				<div>
					<img src="../semi_view/images/index_image/diameter_01.jpg" title="beach">
				</div>
				<div>
					<img src="../semi_view/images/index_image/diameter_02.jpg" title="water_fall">
				</div>
				<div>
					<img src="../semi_view/images/index_image/diameter_03.jpg" title="city">
				</div>
			</div>
