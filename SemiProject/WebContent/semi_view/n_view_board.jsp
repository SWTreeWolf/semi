													...
													<div style="clear: both; height: 30px;">
														...
														<form name="fwrite" method="post">
															<input type="hidden" name="num" value="${dto.num}" /> <input
																...
																type="hidden" name="re_level" value="${dto.re_level}" />
																					...
																					<td valign="top">
																						<div
																							...
																							<div
																								...
																								<a href="*"> <img
																									src="../semi_view/images/co_btn_reply.gif"
																									border="0" align="absmiddle" alt="답변">
																								</a> <a href="*"> <img
																									src="../semi_view/images/co_btn_delete.gif"
