...
public class Notice_PageDTO {
	...
	public Notice_PageDTO() {

	}

	public Notice_PageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
       this(currentPage,totalCount);
       this.searchKey=searchKey;
       this.searchWord=searchWord;
	}

	public Notice_PageDTO(int currentPage, int totalCount) {
