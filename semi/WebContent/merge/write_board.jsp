						 ...
						 var char_min=parseInt(0);//최소
				 		 var char_max=parseInt(0);//최대
									...
									<table width="99%" align="center" cellpadding="0"
										...
										<tbody>
											<tr>
												<td>
													<div
														style="border: 1px solid #ddd; height: 34px; background: url(../merge/images/title_bg.gif) repeat-x;">
														<div
													...
													<table width="100%" border="0" cellspacing="0"
														...
														<tbody>
															...
															<!-- 에디터 -->
															<tr>
																<td colspan="2"><div id="summernote">펜션이용 후기를
																		남겨주세요~</div></td>
															</tr>
															<tr>
																<td colspan="2" height="1" bgcolor="#e7e7e7"></td>
																			...
																			<tr>
																				<td class="write_head"
																					...
																					style="cursor: pointer;"><img
																						src="../merge/images/btn_file_add.gif"></span> <span
																					onclick="del_file();" style="cursor: pointer;"><img
																						src="../merge/images/btn_file_minus.gif"></span>
																				</td>
																			</tr>
																		</tbody>
																	</table>
														...
														<tbody>
															<tr>
																<td width="100%" align="center" valign="top"
																	...
																	id="btn_submit" src="../merge/images/btn_write.gif"
																	border="0" accesskey="s"> <a href="*"><img
																		id="btn_list" src="../merge/images/btn_list.gif" border="0">
																</a></td>
															</tr>
														</tbody>
													</table>
									...
									<link rel="stylesheet" type="text/css"
										href="../merge/css/jquery.realperson.css"> <script
									...
									<link href="../merge/dist/summernote.css" rel="stylesheet"> <script
										src="../merge/dist/summernote.js"></script> <script
										src="../merge/dist/lang/summernote-ko-KR.js"></script> <script
