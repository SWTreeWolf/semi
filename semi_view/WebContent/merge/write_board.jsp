		...
		<tbody>
			...
			<tr>
				<td align="center" >
					...
					<div style="height: 14px; line-height: 1px; font-size: 1px;">&nbsp;</div>
						...
						<table width="99%" align="center" cellpadding="0" cellspacing="0">
							<tbody>
								<tr>
									<td>
										<div style="border: 1px solid #ddd; height: 34px; background: url(../merge/images/title_bg.gif) repeat-x;">
											<div style="font-weigth: bold; font-size: 14px; margin: 7px 0 0 10px;">::글쓰기 ::</div>
										</div>
										<div style="height: 3px; background: url(../merge/images/title_shadow.gif) repeat-x; line-height: 1px; font-size: 1px;"></div>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tbody>
												<tr>
													<td colspan="2"
														style="background: url(../merge/images/title_bg.gif) repeat-x; height: 3px;"></td>
												</tr>
												<tr>
															...
															<tbody>
																<tr>
																	<td class="write_head" style="padding-top: 30px; line-height: 20px;">&nbsp;파일첨부<br>
																	 <span onclick="add_file();" style="cursor: pointer;"><img src="../merge/images/btn_file_add.gif"></span>
																		<span onclick="del_file();" style="cursor: pointer;"><img src="../merge/images/btn_file_minus.gif"></span>
																	</td>
																</tr>
															</tbody>
														</table>
											...
											<tbody>
												<tr>
    												<td width="100%" align="center" valign="top" style="padding-top:30px;">
	        											<input type="image" id="btn_submit" src="../merge/images/btn_write.gif" border="0" accesskey="s">
	        										
														<a href="*"><img id="btn_list" src="../merge/images/btn_list.gif" border="0">
														</a>
        											</td>
												</tr>
											</tbody>
					...
					<!-- 자동가입방지 -->
					<script src="../merge/js/header_jquery-ui.min.js"></script>
					<link rel="stylesheet" type="text/css"href="../merge/css/jquery.realperson.css">
					<!-- <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.4/jquery.js"></script> -->
					<script type="text/javascript" src="../merge/js/jquery.plugin.js"></script>
					<script type="text/javascript" src="../merge/js/jquery.realperson.js"></script> 
				
					<!--에디터-->
					<link href="../merge/css/bootstrap.css" rel="stylesheet">
					<script src="http://netdna.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.js"></script> 
					<link href="../merge/dist/summernote.css" rel="stylesheet"> 
					<script src="../merge/dist/summernote.js"></script>
					<script src="../merge/dist/lang/summernote-ko-KR.js"></script>
